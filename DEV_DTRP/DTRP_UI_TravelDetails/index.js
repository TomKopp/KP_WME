Documa.components.TravelDetails = class extends Documa.components.MashupComponent {
     ...
     */
    show() {
        // window.TravelDetailsRender(document.getElementById(this._renderTargetId));
        window.TravelDetailsRender(this);
    }
    ...
    invokeOperation(operationName, event) {
        console.warn('%cTravelDetails: ', 'background-color: lightblue;', event);

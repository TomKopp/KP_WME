...
Documa.recommendation.trigger.unwiredEvent = Ext.extend(Object, {
	superClass: null,
	subClass: null,
	...
	init: function (recMan, eventDispatcher, log) {
		...
		this.subClass = "unwiredEvent";
		this.recommendationType = "unwiredEvent";
	...
	handle: function (msg) {
		console.log("Handle unwiredEvent Trigger ...");
		...
		console.log("unwiredEvent Trigger handled.");
	}
});